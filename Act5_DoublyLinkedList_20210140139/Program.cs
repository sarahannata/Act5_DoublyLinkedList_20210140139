...
namespace DoublyLinkedList
{
    ...
    class DoubleLinkedList
    {
        ...
        public bool delNode(int rollNo)/*Deletes the specified node*/
        {
            ...
            if (current.next == null)/*If the last node is to be delete*/
            {
                previous.next = null;
                return true;
            }
            /*If the node to be deleted is in beetween the list then the following lines of code is executed.*/
